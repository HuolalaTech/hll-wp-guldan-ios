...
@implementation GDNRecordDetailCell
...
- (void)bindRecordModel:(GDNRecordModel *)model isHiddenExpandBtn:(BOOL)isHidden isExpand:(BOOL)isExpand section:(NSInteger)section isCallCountType:(BOOL)isCallCountType {
    _section = section;
